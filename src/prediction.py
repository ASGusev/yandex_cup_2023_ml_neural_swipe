...
import utils
from features import FeaturesExtractor, FeaturesExtractorNP
...
class ScoringRanker:
    ...
    def __call__(self, sample_traces: list[utils.Trace], candidates: list[list[utils.Candidate]]) \
            -> list[utils.Suggestion]:
        res = []
